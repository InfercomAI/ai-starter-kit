...
The next step is to set up your environment variables to use the inference models available from Infercom. You can obtain an API key through the [Infercom Portal](https://cloud.infercom.ai).
