...
This AI Starter Kit allows users to compare text documents and run custom analyses on them. You send two PDF files or blobs of text to the Infercom server, and get analyses based on your instructions. The Kit includes:
