    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self.request_config.api_variables:
            self.base_url = (
                ...
                if self.request_config.api_variables['INFERCOM_API_BASE']
                else INFERCOM_API_BASE
            )
            self.api_key = self.request_config.api_variables['INFERCOM_API_KEY']
        else:
            self.base_url = os.environ.get('INFERCOM_API_BASE', INFERCOM_API_BASE)
            self.api_key = os.environ.get('INFERCOM_API_KEY', '')
