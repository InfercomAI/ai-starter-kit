...
- Configurable Infercom Cloud connectors. The connectors generate answers from a deployed model. You can also use any of them to run OpenAI compatible endpoints from other providers.
...
The next step is to set up your environment variables to use one of the models available from Infercom. You can obtain an API key through [Infercom Cloud](https://cloud.infercom.ai).
